...
struct DetalhesSheet: View {
    ...
    var body: some View {
        ...
        if mostrandoPagCadCheckin {
            AdicionandoOuEditando(
                id_centro_esportivo: .constant(centroEsportivoCDistancia.centroEsportivo.id),
                nome_centro_esportivo: $centroEsportivoCDistancia.centroEsportivo.ceNome,
                zona_centro_esportivo: $centroEsportivoCDistancia.centroEsportivo.ceZona,
                mostrandoPagCadCheckin: $mostrandoPagCadCheckin,
                checkinSelecionado: $checkinSelecionado,
                salvandoCheckin: $salvandoCheckin)
        } else {
            ScrollView {
